...
$mail->Host = 'mail.miratowns.ca'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@miratowns.ca'; // SMTP username
$mail->Password = 'mail@miratowns'; // SMTP password
