...
<head>
    ...
    <meta property="og:image" content="https://miratowns.ca/mira-family.jpg">


    <meta property="og:site_name" content="Mira Towns" />
...
<body>
    <div class="sticky-top topp " id="header">
        <nav class="navbar navbar-expand-md brand-bg" id="navbar">
            <div class=" container">
    ...
    <section class="my-md-5  " id="about">
        ...
        <div class="container pt-md-4 pt-0">
            ...
            <div class="py-5" id="location">
                <h2 class="fw-bold fs-1 mb-0 text-center justify-content-center brand-color">
                    <span class="mx-1">Mira Towns Barrie - Location </span>
                </h2>
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">700 Mapleview
                ...
                <div class="row row-cols-md-2 row-cols-1 text-center mx-2 mx-md-0">
                    ...
                    <div class="bg-white p-1   rounded-mine d-flex justify-content-center align-items-center col">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2853.066926992834!2d-79.6235444!3d44.3496763!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882abb0d0e00bfd7%3A0x89bdd8b36cf45ed5!2s700%20Mapleview%20Dr%20E%2C%20Barrie%2C%20ON%20L4N%200M2%2C%20Canada!5e0!3m2!1sen!2snp!4v1727453118306!5m2!1sen!2snp"
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingTwo">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            What are the nearby amenities at Mira Towns?
                        </button>
                    </h3>
                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">
                            Mira Towns is located near urban amenities, including shopping centers, restaurants,
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header " id="flush-headingOne">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            Who is the builder of Mira Town house?
                        </button>
                    </h3>
                    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                        data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Dunsire Developments is the builder of Mira Town house.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header " id="flush-headingFive">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            What is the starting price for Mira Towns?
                        </button>
                    </h3>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingFour">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            How close is the Mira townhomes to the Go Station?
                        </button>
                    </h3>
                    <div id="flush-collapseFour" class="accordion-collapse collapse"
                        aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Mira Townhomes is located just steps away from the Go Station,
                            providing a seamless commute to surrounding areas and quick access to public transportation.
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h3 class="accordion-header" id="flush-headingThree">
                        <button class="accordion-button collapsed " type="button" data-bs-toggle="collapse"
                            ...
                            What makes Barrie, Ontario, a great place to live?
                        </button>
                    </h3>
                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                        aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body">Barrie offers the perfect blend of convenience and coastal charm.
                            With prime properties located near the Go Station, residents enjoy easy access to urban
                            amenities while being just minutes away from the sandy beaches of Lake Simcoe.</div>
                    </div>
                </div>
